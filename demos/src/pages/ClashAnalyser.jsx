...
const COLORS = { n: '#fb7185', a: '#fbbf24', r: '#38bdf8', p: '#34d399', s: '#2dd4bf' };
...
const SEV = [['Critical', 64, 14, '#fb7185'], ['High', 198, 42, '#fbbf24'], ['Medium', 241, 52, '#fbbf24'], ['Low', 95, 20, '#34d399']];
...
export default function ClashAnalyser() {
  ...
  const tiles = [['tot', 'Total', '#38bdf8'], ['n', 'New'], ['a', 'Active'], ['r', 'Reviewed'], ['p', 'Approved'], ['s', 'Resolved']];
        ...
        <div className="row2">
          <div className="card" style={{ width: 230 }}>
            ...
            <svg viewBox="0 0 220 70" width="100%" height="70">
              <polyline style={{ strokeDasharray: 400, animation: 'draw 1.6s .3s both' }} fill="none" stroke="#6ea8fe" strokeWidth="3" points="5,12 35,20 65,26 95,34 125,38 155,48 185,54 215,60" />
              <polyline style={{ strokeDasharray: 400, animation: 'draw 1.6s .5s both' }} fill="none" stroke="#38bdf8" strokeWidth="3" points="5,60 35,56 65,50 95,44 125,38 155,30 185,22 215,14" />
            </svg>
            <div style={{ fontSize: 10.5, display: 'flex', gap: 14, marginTop: 4 }}><span style={{ color: '#6ea8fe' }}>&#9632; Open</span><span style={{ color: '#38bdf8' }}>&#9632; Resolved</span></div>
          </div>
